...
public class CvResponse {
    ...
    public CvResponse(int id, String nom, String prenom, String age, String adresse, String email, String telephone, String specialite, String niveauEtude, String experienceProfessionnelle) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.age = age;
